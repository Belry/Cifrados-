...
if __name__ == '__main__':
    ...
    plaintext = PlaintextMessage('This is a test for the function.', 6)
    print('Expected Output: Znoy oy g zkyz lux znk latizout.')
    print('Actual Output:', plaintext.get_message_text_encrypted())

    ciphertext = CiphertextMessage('Znoy oy g zkyz lux znk latizout.')
    print('Expected Output:', (20, 'This is a test for the function.'))
    print('Actual Output:', ciphertext.decrypt_message())
